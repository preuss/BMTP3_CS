...
public interface ITraversalScanner<TEntry>
{
	...
	/// </summary>
	IEnumerable<TEntry> Scan(string rootPath, bool recursive = true, IProgress<TraversalProgress>? progress = null,
	...
	/// </summary>
	IAsyncEnumerable<TEntry> ScanAsync(string rootPath, bool recursive = true,
