# Task 004: preflight align target framework

**Filnavn:** 004_[NEED]_preflight-align-target-framework.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Ret TargetFramework i **begge** csproj'er: `BMTP3.Core4.csproj` og `BMTP3.Core4.Tests.csproj` (`net10.0` → match repo).
