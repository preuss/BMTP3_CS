# Task 013: create isidecargenerator

**Filnavn:** 013_[NEED]_create-isidecargenerator.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Opret `Sidecar/ISidecarGenerator.cs` (internal interface). Afhænger af: `BackupItem`, `TransferResult` (009), `SidecarEnrichment` (012).
