...
namespace BMTP3.Core2.Tests.Hashing
{
    public class ItemHasherTests
    {
        ...
        {
            var logger      = new TestLogger<ItemHasher>();
            var genLogger   = new Microsoft.Extensions.Logging.Abstractions.NullLogger<StreamHashGenerator>();
            var generator   = new StreamHashGenerator(genLogger);
        ...
        {
            var content = new FileContent(filePath);
        ...
        public async Task ComputeHashesAsync_SHA256_ReturnsCorrectHash()
        {
            ...
            try
            {
                ...
                var result = await hasher.ComputeHashesAsync(
                    item,
        ...
        public async Task ComputeHashesAsync_EmptyHashTypeList_DefaultsToSHA256()
        {
            ...
            try
            {
                ...
                var result = await hasher.ComputeHashesAsync(
                    item,
                    hashTypes: new List<HashType>(),   // empty → should default to SHA2_256
                    progress: null!,
                    CancellationToken.None);
        ...
        public async Task ComputeHashesAsync_MultipleTypes_ReturnsAll()
        {
            ...
            try
            {
                ...
                var requested = new List<HashType> { HashType.SHA2_256, HashType.MD5_128 };
