# Task 079: wire enrichment pipeline after sidecar

**Filnavn:** 079_[NICE]_wire-enrichment-pipeline-after-sidecar.md  
**Prioritet:** [NICE]  
**Milestone-spor:** Post-baseline feature expansion

## Formaal
Kald enrichment (hash → metadata → verify → timestamp → sidecar.UpdateAsync) efter succesfuld transfer. Brug `SidecarEnrichment` (oprettet i task 012).
