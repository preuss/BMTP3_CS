# Task 002: delete unittest1 and empty fakes

**Filnavn:** 002_[NEED]_delete-unittest1-and-empty-fakes.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Slet `BMTP3.Core4.Tests/UnitTest1.cs` og de tre tomme Fakes-stubs (`FakeBackupScanner.cs`, `FakeFileTransfer.cs`, `FakeSidecarGenerator.cs`).
