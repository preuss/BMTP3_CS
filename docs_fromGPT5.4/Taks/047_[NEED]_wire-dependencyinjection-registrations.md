# Task 047: wire dependencyinjection registrations

**Filnavn:** 047_[NEED]_wire-dependencyinjection-registrations.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Registrér alle services: Scanner, Transfer, Sidecar, ProgressTracker, SessionStateStore, Engine, Factory.
