# Task 049: wire core4 into bmtp3 consoles

**Filnavn:** 049_[NEED]_wire-core4-into-bmtp3-consoles.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Tilføj `services.AddBMTP3Core4()` i Consoles' DI-setup. Tilføj ny ConsoleCommand (eller udvid eksisterende) der kalder `IBackupEngine.RunAsync`.
