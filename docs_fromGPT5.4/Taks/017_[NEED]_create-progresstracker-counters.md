# Task 017: create progresstracker counters

**Filnavn:** 017_[NEED]_create-progresstracker-counters.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Opret `Progress/ProgressTracker.cs` med tæller-felter og `SetPhase`, `ItemDiscovered`, `DirectoryScanned`. Brug `Interlocked` for thread-safety.
