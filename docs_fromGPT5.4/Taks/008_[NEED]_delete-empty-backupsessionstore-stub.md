# Task 008: delete empty backupsessionstore stub

**Filnavn:** 008_[NEED]_delete-empty-backupsessionstore-stub.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Slet `Engine/State/BackupSessionStore.cs` (tom klasse). **Behold** `InMemoryBackupSessionStateStore.cs` — den er implementeret og bruges.
