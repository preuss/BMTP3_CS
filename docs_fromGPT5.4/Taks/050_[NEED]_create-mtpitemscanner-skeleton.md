# Task 050: create mtpitemscanner skeleton

**Filnavn:** 050_[NEED]_create-mtpitemscanner-skeleton.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 2: MTP baseline end-to-end

## Formaal
`Scanner/MTP/MTPItemScanner.cs` (implementerer `IBackupScanner`). Tilføj MediaDevices DLL-reference til csproj.
