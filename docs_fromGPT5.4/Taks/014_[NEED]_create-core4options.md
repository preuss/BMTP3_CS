# Task 014: create core4options

**Filnavn:** 014_[NEED]_create-core4options.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Opret `DependencyInjection/Core4Options.cs` (public class med defaults). Flyttes hertil fordi `FilesystemFileTransfer` (020) bruger `Core4Options.TransferBufferSizeBytes`. Tilføj også NuGet-ref til `Microsoft.Extensions.Options` hvis nødvendigt.
