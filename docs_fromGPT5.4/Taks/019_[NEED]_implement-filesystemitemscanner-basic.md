# Task 019: implement filesystemitemscanner basic

**Filnavn:** 019_[NEED]_implement-filesystemitemscanner-basic.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Opret `Scanner/Filesystem/FilesystemItemScanner.cs` (implementerer `IBackupScanner`). Brug `Directory.EnumerateFiles`. Yield `BackupItem` per fil. Foundation: ingen glob-filter endnu — yield alle filer.
