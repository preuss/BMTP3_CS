...
public sealed record TimestampSources
{
	...
	public override string ToString()
	{
		...
		if (SubSeconds != null)
		{
			builder.Append($"<SubSeconds>{SubSeconds}</SubSeconds>");
		}

		if (Offset != null)
		{
			builder.Append($"<Offset>{Offset}</Offset>");
		}

		if (DateTime != null)
		{
			builder.Append($"<DateTime>{DateTime}</DateTime>");
		}

		if (DateTimeOffset != null)
		{
			builder.Append($"<DateTimeOffset>{DateTimeOffset}</DateTimeOffset>");
		}
