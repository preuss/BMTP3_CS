# Task 022: implement filesystemfiletransfer cleanup

**Filnavn:** 022_[NEED]_implement-filesystemfiletransfer-cleanup.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Ryd `.tmp` op ved Exception. `OperationCanceledException` re-throws altid. Alle andre exceptions → `TransferResult { Succeeded = false }`.
