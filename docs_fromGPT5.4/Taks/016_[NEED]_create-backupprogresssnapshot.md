# Task 016: create backupprogresssnapshot

**Filnavn:** 016_[NEED]_create-backupprogresssnapshot.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Opret `Progress/BackupProgressSnapshot.cs` (implementerer `IBackupProgress`). Afhænger af: `FileProgressSnapshot` (015).
