...
{
	public HashPipelineStageForAbstract(ILogger logger, int parallelism, HashStepContext context, List<IBackupItemStep<HashStepContext, HashStepResult>> steps, ProgressTracker tracker)
