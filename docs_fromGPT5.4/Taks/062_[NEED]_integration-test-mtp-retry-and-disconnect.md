# Task 062: integration test mtp retry and disconnect

**Filnavn:** 062_[NEED]_integration-test-mtp-retry-and-disconnect.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 2: MTP baseline end-to-end

## Formaal
Denne task er defineret i index uden ekstra noter. Brug navnet som styrende scope og hold loesningen minimal men fuldendt.
