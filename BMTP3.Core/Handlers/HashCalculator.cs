...
namespace BMTP3.Core.Handlers {
	public class HashCalculator {
		...
		/// <param name="bufferSize">The size of the buffer used for reading the file (default: 8 KB for balanced memory and I/O performance).</param>
		...
		public IReadOnlyDictionary<HashType, string> ComputeHashes(
			...
			ImmutableDictionary<HashType, string>.Builder hashResultsBuilder = ImmutableDictionary.CreateBuilder<HashType, string>();
