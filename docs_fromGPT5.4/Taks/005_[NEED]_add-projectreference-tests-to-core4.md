# Task 005: add projectreference tests to core4

**Filnavn:** 005_[NEED]_add-projectreference-tests-to-core4.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Tilføj `<ProjectReference>` fra `BMTP3.Core4.Tests` → `BMTP3.Core4`. Tilføj `[InternalsVisibleTo("BMTP3.Core4.Tests")]` i Core4 (kræves fordi de fleste Core4-typer er `internal`).
