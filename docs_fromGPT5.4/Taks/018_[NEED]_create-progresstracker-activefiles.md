# Task 018: create progresstracker activefiles

**Filnavn:** 018_[NEED]_create-progresstracker-activefiles.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Udvid `ProgressTracker` med `StartFile`, `UpdateFileBytesTransferred`, `CompleteFile`, `SkipFile`, `GetSnapshot()`. Brug `ConcurrentDictionary` for active files.
