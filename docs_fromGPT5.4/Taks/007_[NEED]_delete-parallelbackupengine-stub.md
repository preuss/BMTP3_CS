# Task 007: delete parallelbackupengine stub

**Filnavn:** 007_[NEED]_delete-parallelbackupengine-stub.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Slet KUN `Engine/Parallel/ParallelBackupEngine.cs`. **Behold** `Engine/LimitedParallel/LimitedParallelBackupEngine.cs` — den bruges i [LATER] task 081.
