...
public class TimestampFormatterTests
{
    ...
    {
        TimeOnly time = new TimeOnly(dto.Hour, dto.Minute, dto.Second);
        return new TimestampCandidate(
            sourceType: TimestampSourceType.Exif,
            role: TimestampRole.Created,
            sources: new TimestampSources { DateTimeOffset = dto.ToString("o") },
    ...
    private static TimestampCandidate CandidateFrom(DateOnly date, TimeOnly time, TimeSpan? offset, long? subSeconds = null)
    {
    ...
    public void Format_ISO8601_DotFraction_NoSubseconds_ProducesCorrectString()
    {
        ...
        DateTimeOffset dto = new DateTimeOffset(2026, 1, 13, 14, 30, 0, TimeSpan.Zero);
    ...
    {
        DateTimeOffset dto = new DateTimeOffset(2024, 6, 1, 12, 0, 0, TimeSpan.Zero);
        TimestampCandidate candidate = CandidateFrom(dto);
    ...
    public void Format_NegativeOffset_ProducesMinusSign()
    {
        ...
        DateTimeOffset dto = new DateTimeOffset(2024, 3, 10, 9, 0, 0, negOffset);
        TimestampCandidate candidate = CandidateFrom(dto);
    ...
    public void Format_WithMillisecondSubseconds_Produces3DecimalDigits()
    {
        ...
        DateTimeOffset dto = new DateTimeOffset(2025, 2, 28, 10, 20, 30, TimeSpan.Zero);
        TimestampCandidate candidate = CandidateFrom(dto, subSeconds: subSeconds);
    ...
    public void Format_CommaFractionStyle_UsesCommaNotDot()
    {
        ...
        DateTimeOffset dto = new DateTimeOffset(2025, 6, 15, 8, 0, 0, TimeSpan.Zero);
        TimestampCandidate candidate = CandidateFrom(dto, subSeconds: subSeconds);
    ...
    public void Format_EmptyCandidate_ToStringReturnsEmptyTimestampMarker()
    {
        ...
        TimestampCandidate empty = new TimestampCandidate(
            sourceType: TimestampSourceType.Exif,
            role: TimestampRole.Unknown,
