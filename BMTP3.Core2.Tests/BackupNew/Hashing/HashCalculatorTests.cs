...
public class HashCalculatorTests
{
    ...
    public void ComputeHashes_SHA2_256_ReturnsCorrectHex()
    {
        ...
        try
        {
            var result = _calc.ComputeHashes(tempFile, new[] { HashType.SHA2_256 });
    ...
    public void ComputeHashes_SHA2_512_ReturnsCorrectHex()
    {
        ...
        try
        {
            var result = _calc.ComputeHashes(tempFile, new[] { HashType.SHA2_512 });
    ...
    public void ComputeHashes_MD5_128_ReturnsCorrectHex()
    {
        ...
        try
        {
            var result = _calc.ComputeHashes(tempFile, new[] { HashType.MD5_128 });
    ...
    public void ComputeHashes_BLAKE3_256_ReturnsNonEmptyHex()
    {
        ...
        try
        {
            var result = _calc.ComputeHashes(tempFile, new[] { HashType.BLAKE3_256 });
    ...
    public void ComputeHashes_BLAKE3_512_ReturnsNonEmptyHex()
    {
        ...
        try
        {
            var result = _calc.ComputeHashes(tempFile, new[] { HashType.BLAKE3_512 });
    ...
    public void ComputeHashes_MultipleTypes_ReturnsAllRequested()
    {
        ...
        try
        {
            var types = new[] { HashType.SHA2_256, HashType.MD5_128 };
            var result = _calc.ComputeHashes(tempFile, types);
    ...
    public void ComputeHashes_SHA3_256_FIPS202_ReturnsNonEmptyHex()
    {
        ...
        try
        {
            var result = _calc.ComputeHashes(tempFile, new[] { HashType.SHA3_256_FIPS202 });
