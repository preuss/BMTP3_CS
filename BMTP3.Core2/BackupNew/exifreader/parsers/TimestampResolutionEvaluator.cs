...
public static class TimestampResolutionEvaluator
{
	...
	/// </summary>
	private const long
		MaxValidTicks = 3_155_378_976_000_000_000L - 1; // Maximum valid ticks value (0 to 3,155,378,975,999,999,999)
	...
	/// </summary>
	private static readonly Dictionary<TimestampResolution, long> NanosecondsPerUnitMap = new()
	{
		...
		if (expected == TimestampResolution.Ticks100Ns)
		{
			...
			if (absValue > MaxValidTicks)
			{
				throw new ArgumentOutOfRangeException(nameof(value),
					"The numeric value exceeds the valid range for 100-nanosecond ticks.");
			}
	...
	/// </summary>
	private static TimestampResolution GetHighestPrecision(TimestampResolution resolution1,
		TimestampResolution resolution2)
	{
	...
	public static long ScaleToResolution(long value, TimestampResolution fromResolution,
		TimestampResolution toResolution)
	{
