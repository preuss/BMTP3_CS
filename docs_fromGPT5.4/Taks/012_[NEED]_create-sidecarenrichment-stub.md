# Task 012: create sidecarenrichment stub

**Filnavn:** 012_[NEED]_create-sidecarenrichment-stub.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Opret `Sidecar/SidecarEnrichment.cs` (sealed class, alle felter nullable). Denne klasse skal eksistere nu fordi `ISidecarGenerator.UpdateAsync` (task 013) refererer til den i sin signatur. Felterne udfyldes først i [NICE]-fasen.
