# Task 003: fix collisionstrategy filename typo

**Filnavn:** 003_[NEED]_fix-collisionstrategy-filename-typo.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Omdøb `Models/Enums/CollisionStreategy.cs` → `CollisionStrategy.cs`. Enum-navnet indeni er korrekt — kun filnavnet har en typo.
