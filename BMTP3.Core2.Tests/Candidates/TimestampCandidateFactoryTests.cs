...
public class TimestampCandidateFactoryTests
{
	...
	{
		return TimestampCandidateFactory.FromDateTime(TimestampSourceType.Exif, TimestampRole.Created, dt);
	}

	private static TimestampCandidate MakeFromDateTimeOffset(DateTimeOffset dto)
	{
		return TimestampCandidateFactory.FromDateTimeOffset(TimestampSourceType.Exif, TimestampRole.Created, dto);
	}
	...
	public void TrimToNanoseconds_WholeSecondTicks_ReturnsNull()
	{
		...
		long? result = TimestampCandidateFactory.TrimToNanoseconds(wholeTicks);
	...
	public void TrimToNanoseconds_HalfSecondTicks_ReturnsExpectedNanoseconds()
	{
		...
		long? result = TimestampCandidateFactory.TrimToNanoseconds(halfSecondTicks);
	...
	{
		DateTime utcDt = new(2024, 6, 1, 12, 0, 0, DateTimeKind.Utc);
	...
	public void OffsetToTimeSpan_DateTimeOffset_ReturnsExactOffset()
	{
		...
		DateTimeOffset dto = new(2024, 6, 1, 14, 0, 0, expectedOffset);
	...
	{
		DateTime dt = new(2023, 3, 15, 10, 30, 45, DateTimeKind.Utc);
	...
	{
		DateTime dt = new(2023, 3, 15, 10, 30, 45, DateTimeKind.Unspecified);
		TimestampCandidate candidate = MakeFromDateTime(dt);
	...
	public void FromDateTime_WithSubSecondFractions_SubSecondsExtractedAndTimeStripped()
	{
		...
		DateTime dt = new(2023, 1, 1, 12, 0, 0, 500, DateTimeKind.Utc);
		TimestampCandidate candidate = MakeFromDateTime(dt);
	...
	public void FromDateTimeOffset_PreservesOffset()
	{
		...
		DateTimeOffset dto = new(2024, 8, 20, 16, 45, 30, offset);
	...
	public void FromDateTimeOffset_NegativeOffset_PreservedCorrectly()
	{
		...
		DateTimeOffset dto = new(2024, 11, 5, 9, 0, 0, offset);
		TimestampCandidate candidate = MakeFromDateTimeOffset(dto);
