# Task 076: implement bestdate selection rules

**Filnavn:** 076_[NICE]_implement-bestdate-selection-rules.md  
**Prioritet:** [NICE]  
**Milestone-spor:** Post-baseline feature expansion

## Formaal
`GetBestDate()`: DateTimeOriginal → CreateDate → QuickTimeCreated → FileSystemLastWrite → FileSystemCreation → null.
