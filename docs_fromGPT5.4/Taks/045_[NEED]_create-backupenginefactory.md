# Task 045: create backupenginefactory

**Filnavn:** 045_[NEED]_create-backupenginefactory.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
`Engine/BackupEngineFactory.cs` — vælger engine baseret på plan. Foundation: returner altid `SequentialBackupEngine`.
