# Task 027: implement sequentialengine resolvedestination

**Filnavn:** 027_[NEED]_implement-sequentialengine-resolvedestination.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Privat `ResolveDestination(item, plan)` baseret på `OutputStructure`. Foundation: `PreserveHierarchy` og `Flat`. Collision-rename kommer i [SHOULD].
