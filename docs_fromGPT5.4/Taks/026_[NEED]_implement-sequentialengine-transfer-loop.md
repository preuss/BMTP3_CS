# Task 026: implement sequentialengine transfer loop

**Filnavn:** 026_[NEED]_implement-sequentialengine-transfer-loop.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Implementér transfer-loop: `session.GetPendingItems()` → `ResolveDestination` → `fileTransfer.TransferAsync` → `sidecarGenerator.CreateAsync` ved succes.
