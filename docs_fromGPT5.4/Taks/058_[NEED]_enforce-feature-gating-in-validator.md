# Task 058: enforce feature gating in validator

**Filnavn:** 058_[NEED]_enforce-feature-gating-in-validator.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 2: MTP baseline end-to-end

## Formaal
Validator: flag-kombinations der kræver endnu ikke implementerede features → ValidationException med klar besked.
