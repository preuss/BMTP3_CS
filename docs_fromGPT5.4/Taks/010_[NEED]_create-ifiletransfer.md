# Task 010: create ifiletransfer

**Filnavn:** 010_[NEED]_create-ifiletransfer.md  
**Prioritet:** [NEED]  
**Milestone-spor:** Milestone 1: Filesystem baseline via CLI

## Formaal
Opret `Transfer/IFileTransfer.cs` (internal interface). Afhænger af: `BackupItem` (eksisterer), `TransferResult` (009).
