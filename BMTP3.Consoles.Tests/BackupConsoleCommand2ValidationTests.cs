...
namespace BMTP3.Consoles.Tests
{
    public class BackupConsoleCommand2ValidationTests
    {
        ...
        public void ValidateBackupOptions_WithCustomPathPattern_MissingPathPattern_Throws()
        {
            ...
            var ex = Assert.Throws<ArgumentException>(() => CallValidate(model));
        ...
        {
            var method = typeof(BackupConsoleCommand2).GetMethod("ValidateBackupOptions", 
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var command = new BackupConsoleCommand2();
        ...
        {
            var method = typeof(BackupConsoleCommand2).GetMethod("EngineArgumentBuilder", 
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var command = new BackupConsoleCommand2();
            command.GetType().GetProperty("ServiceProvider")?.SetValue(command, null);
