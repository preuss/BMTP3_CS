...
/// <summary>
/// See url https://github.com/stevesimmons/uuid7-csharp
/// 
...
public class Uuid7
{
	...
	public Uuid7(TimeProvider? timeProvider = null)
	{
	...
	{
		return 100 * (_timeProvider.GetUtcNow().Ticks - DateTime.UnixEpoch.Ticks);
	}
	...
	public static string Id25(Guid guid)
	{
		...
		BigInteger rest = new(arr, true, true);
		BigInteger rem;
	...
	public static string CheckTimingPrecision()
	{
		...
		int numSamples = distinctValues.Count;
		double actualPrecisionNs = 1_000_000 * sw.Elapsed.TotalMilliseconds / numSamples;
		double maxPrecisionNs = 1_000_000 * sw.Elapsed.TotalMilliseconds / numLoops;
